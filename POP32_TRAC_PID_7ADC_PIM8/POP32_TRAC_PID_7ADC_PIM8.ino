#include <POP32.h>
int L3, L2, L1, C1, C2, R1, R2, R3; //ตัวแแปรเก็บค่าเซนนเซอร์
int RefL3, RefL2, RefL1, RefC1,RefC2 , RefR1, RefR2, RefR3; //ตัวแปรเก็บค่าเฉลี่ยเซนนเซอร์
...
void setup() {
  ...
  ACCSpeed = 70;  //ความเร็วตอนเร่ง 100
  ...
  // Forward(Speed, 1500); //เดินหน้าหน่วงเวลา วิ่งที่ 50% เป็นนเวลา 2 วินาที
  // TracJC(Speed, 40);
  // TurnRight();
  // TracJC(Speed, 40);
  // TurnLeft();
